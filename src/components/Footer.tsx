    ...
    <footer className="bg-primary text-white/80 py-16">
      <div className="container-tight">
          ...
          <div className="md:col-span-2 space-y-4">
            <div className="flex items-center gap-2.5">
              ...
              <div className="leading-tight">
                <div className="font-display font-bold text-lg text-white">LavaTec</div>
            ...
            <p className="text-sm max-w-md leading-relaxed">
              ...
              em Osasco e todo estado de São Paulo.
            </p>
        ...
        <div className="pt-8 border-t border-white/10 flex flex-col md:flex-row justify-between items-center gap-4 text-xs text-white/50">
          <div>© {new Date().getFullYear()} LavaTec Assistência Técnica. Todos os direitos reservados.</div>
